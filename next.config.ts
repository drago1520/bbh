...
if (
  process.env.KK ==
  "I stopped posthog because of build error bug with posthog/cli"
)
  finalConfig = withPostHogConfig(finalConfig, {
    ...
    sourcemaps: {
      // (optional)
      enabled: process.env.POSTHOG_SOURCEMAPS == "true" ? true : false, // (optional) Enable sourcemaps generation and upload, default to true on production builds
