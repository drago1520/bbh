...
//! I modified it to always have <Link> from next.js; bugs can arrise!
function BreadcrumbLink({ className, href, children, ...props }: React.ComponentProps<'a'> & LinkProps) {
  return (
    <Slot data-slot="breadcrumb-link" className={cn('hover:text-foreground transition-colors', className)} {...props}>
