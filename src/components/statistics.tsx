    ...
    <section className={cn('py-12', className)} aria-labelledby="statistics-heading" {...props}>
      <div className="container text-7xl sm:text-6xl">
        ...
        <dl className="mt-8 grid justify-center gap-16 text-center min-[480px]:grid-cols-2 min-[480px]:gap-8 lg:grid-cols-3">
          <div className="dark:bg-accent flex w-full max-w-80 flex-col items-center justify-center gap-4 rounded p-8 shadow-xl dark:border-2">
          ...
          <div className="dark:bg-accent flex w-full max-w-80 flex-col items-center justify-center gap-4 rounded p-8 shadow-xl min-[480px]:col-span-full min-[480px]:justify-self-center lg:col-span-1 dark:border-2">
