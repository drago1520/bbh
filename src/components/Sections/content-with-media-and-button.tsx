    ...
    <SectionWrapper className={cn(className)} {...props}>
      ...
      <div>
        <ContentSection>
          ...
          <p>Най-силните контакти не се създават с размяната на визитки, а със задълбочени разговори с цел помагане на отсрещния човек. Умението да даваш, преди да поискаш, е най-ценният актив, който можеш да носиш със себе си на всяко събитие. Защото само с тази нагласа ще можеш да се свържеш на по-дълбоко ниво с останалите хора. </p>
          <p>Ти си само на една смислена среща разстояние от следващия си бизнес партньор или приятел за цял живот.</p>
        </ContentSection>
