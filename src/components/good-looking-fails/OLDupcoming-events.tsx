...
export default function UpcomingEventsOLD() {
      ...
      <div className="container">
        ...
        <Tabs value={selectedEvent.id.toString()} onValueChange={handleEventChange} className="w-full">
          <ScrollArea className="w-full whitespace-nowrap">
            <TabsList className="h-auto space-x-2 bg-transparent">
              {events.map(event => (
                <TabsTrigger key={event.id} value={event.id.toString()} className="bg-background data-[state=active]:border-brand-accent min-w-[200px] cursor-pointer rounded-md border-b-2 px-8 py-4 inset-shadow-sm data-[state=active]:border-b-2">
        ...
        <div className="grid gap-8 xl:grid-cols-12 xl:gap-12">
          <div className="flex pt-6 xl:col-span-8">
            <div className="w-full">
              <Link href="#">
                <Image src={selectedEvent.image || '/placeholder.svg'} alt={selectedEvent.title} width={1920} height={1080} className="aspect-video rounded-md object-cover" />
              </Link>
          ...
          <div className="prose dark:prose-invert xl:col-span-4 xl:pt-6">
            ...
            <div className="mb-6 space-y-2">
              ...
              <Link href="#" className="text-muted-foreground flex items-center gap-2 no-underline underline-offset-4 hover:underline">
            ...
            <Button size="lg" className="mt-8 w-full lg:w-auto">
