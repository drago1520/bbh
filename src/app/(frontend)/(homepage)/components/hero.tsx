...
export default function Hero({ heroImg, subheading }: { heroImg: Page['heroImg']; subheading: Page['subheading'] }) {
    ...
    <section className="relative flex flex-col">
      ...
      <div className="relative z-10 container flex flex-1 flex-col items-center justify-center gap-16 py-16 text-center md:gap-20 md:py-20 xl:gap-32 xl:py-32">
        <div className="max-w-4xl">
          ...
          <p className="text-shadow mt-4 text-xl text-gray-200 text-shadow-lg">{subheading}</p>
        </div>
        <div>
          <ServiceCards />
        </div>
