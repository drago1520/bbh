      ...
      <div className="container grid grid-cols-1 items-center gap-6 sm:gap-12 xl:grid-cols-2 xl:gap-12">
        ...
        <div className="flex h-full items-center">
          <div className="bg-muted p-12">
            <h2 className="/80 scroll-m-20 text-lg tracking-tight">Нашата мисия</h2>
            <h3 className="mb-4 text-xl font-bold sm:text-2xl lg:mb-6 lg:text-3xl">Създадохме Digital Sea защото...</h3>
