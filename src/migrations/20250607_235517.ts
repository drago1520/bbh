...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_events_active" AS ENUM('false', 'true');
  ...
  CREATE TABLE IF NOT EXISTS "events" (
  	...
  	"active" "enum_events_active" DEFAULT 'true' NOT NULL,
  	"location" varchar DEFAULT 'Gravity Ruin Bar, ет.2, Бургас' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_attendees_fk" FOREIGN KEY ("attendees_id") REFERENCES "public"."attendees"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "attendees_name_idx" ON "attendees" USING btree ("name");
  CREATE INDEX IF NOT EXISTS "attendees_event_idx" ON "attendees" USING btree ("event_id");
  CREATE INDEX IF NOT EXISTS "attendees_updated_at_idx" ON "attendees" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "attendees_created_at_idx" ON "attendees" USING btree ("created_at");
  CREATE UNIQUE INDEX IF NOT EXISTS "events_title_idx" ON "events" USING btree ("title");
  ...
  CREATE INDEX IF NOT EXISTS "events_active_idx" ON "events" USING btree ("active");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_attendees_id_idx" ON "payload_locked_documents_rels" USING btree ("attendees_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_events_active";
